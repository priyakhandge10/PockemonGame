...
import com.example.pockemongame.Pockemon
import com.example.pockemongame.R
...
class MapsActivity : FragmentActivity(), OnMapReadyCallback  {
    ...
    fun  LoadPockemon(){
        ...
        listPockemons.add(Pockemon(R.drawable.charmander,
            "Charmander", "Charmander living in japan", 55.0, 19.2097790416, 72.9723930359))
        listPockemons.add(Pockemon(R.drawable.bulbasaur,
            "Bulbasaur", "Bulbasaur living in usa", 90.5,19.2286250036, 72.9767918587))
        listPockemons.add(Pockemon(R.drawable.squirtle,
            "Squirtle", "Squirtle living in iraq", 33.5, 19.2238814247, 72.9794311523))
